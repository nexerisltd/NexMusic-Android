                                ...
                                AnimatedActionButton(
                                    ...
                                    onClick = {
                                        if (isDownloadComplete) {
                                            ...
                                            val urlToDownload = currentStatus.apkUrl ?: "https://github.com/nexerisltd/NexMusic-Android/releases/download/${currentStatus.version}/NexMusic.apk"
...
suspend fun checkForUpdate(
    ...
    withContext(Dispatchers.IO) {
        try {
            val url = URL("https://api.github.com/repos/nexerisltd/NexMusic-Android/releases/latest")
            ...
            if (shouldShow) {
                ...
                try {
                    val changelogUrl =
                        URL("https://github.com/nexerisltd/NexMusic-Android/releases/download/$tagWithPrefix/changelog.json")
