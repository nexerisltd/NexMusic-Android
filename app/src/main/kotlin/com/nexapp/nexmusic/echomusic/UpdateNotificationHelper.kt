...
object UpdateNotificationHelper {
    ...
    fun showUpdateNotification(context: Context, versionName: String) {
        ...
        val apkUrl = if (versionName.contains("nightly", ignoreCase = true)) {
            "https://nightly.link/nexerisltd/NexMusic-Android/workflows/nightly.yml/main/nexmusic-gms-nightly.zip"
        } else {
            "https://github.com/nexerisltd/NexMusic-Android/releases/download/$versionName/NexMusic.apk"
        }
