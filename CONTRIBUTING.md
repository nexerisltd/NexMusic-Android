...
3. Add the upstream repository:
   ```bash
   git remote add upstream https://github.com/nexerisltd/NexMusic-Android.git
   ```
...
1. Check the [GitHub Discussions](https://github.com/nexerisltd/NexMusic-Android/discussions)
