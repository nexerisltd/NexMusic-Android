...
- `chore(l10n): update translations` ([#999](https://github.com/NexMusicApp/Echo-Music/pull/999)) by @weblate
- `fix: guard lyrics blur RenderEffect behind API 31 check` ([#992](https://github.com/NexMusicApp/Echo-Music/pull/992)) by @berruetaa
- `fix: Happens when refetching a song's lyrics` ([#1014](https://github.com/NexMusicApp/Echo-Music/pull/1014)) by @Chetan786
- `fix(cast): throttle volume slider, add thumbnail, remove dead code` ([#1024](https://github.com/NexMusicApp/Echo-Music/pull/1024)) by @Hitomatito
- `fix(cast): fix queue lifecycle — looping, race condition, and bidirectional extension` ([#1031](https://github.com/NexMusicApp/Echo-Music/pull/1031)) by @Hitomatito
